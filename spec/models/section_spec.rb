...
RSpec.describe Section, type: :model do
  ...
  describe '.batch_request_data' do
    it 'returns the right data' do
      ...
      segment_1 = FactoryBot.create(:segment, bible: bible, book: book, chapter: chapter, heading: heading, usx_position: 6, usx_style: 'm')
      verse_1 = FactoryBot.create(:verse, bible: bible, book: book, chapter: chapter, number: 1)
      FactoryBot.create(:fragment, bible: bible, book: book, chapter: chapter, heading: heading, segment: segment_1, verse: verse_1, content: "In the beginning God created the heavens and the earth.", position: 1, show_verse: true, kind: "text")
      ...
      segment_2 = FactoryBot.create(:segment, bible: bible, book: book, chapter: chapter, heading: heading, usx_position: 6, usx_style: 'm')
      verse_2 = FactoryBot.create(:verse, bible: bible, book: book, chapter: chapter, number: 13)
